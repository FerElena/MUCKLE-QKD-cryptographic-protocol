...
int main()
{
   ...
   uint8_t r_id[32] = {0xFF, 0x95, 0xA7, 0x0F, 0x89, 0xCA, 0x0E, 0x3D,
                      ...
                      0x6B, 0xA3, 0x9F, 0x45, 0xE2, 0x38, 0x81, 0xBC,
                      0x7D, 0xC9, 0x01, 0xF4, 0x56, 0xAA, 0xEF, 0x56};
   uint8_t p_id[32] = {0xFF, 0x95, 0xA7, 0x0F, 0x89, 0xCA, 0x0E, 0x3D,
                      0x7A, 0xB6, 0x23, 0x8C, 0x5E, 0xD4, 0xFF, 0x12,
                      0x6B, 0xA3, 0x9F, 0x45, 0xE2, 0x38, 0x81, 0xBC,
                      0x7D, 0xC9, 0x01, 0xF4, 0x56, 0xAA, 0xEF, 0x56};

   key_exchange_MUCKLE mucke_initializer(INITIALIZER,r_id,p_id, l_A, l_B, l_CKEM, l_QKEM, sec_state, psk, hmac256_sha3_256, 256, hkdf_sha2_256, hkdf_sha2_256, secpk256r1_curve, ml_kem_256);
   key_exchange_MUCKLE mucke_responder(RESPONDER,r_id,p_id, l_A, l_B, l_CKEM, l_QKEM, sec_state, psk, hmac256_sha3_256, 256, hkdf_sha2_256, hkdf_sha2_256, secpk256r1_curve, ml_kem_256);
